 ...
 */
final class Version20241015082243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, room_id_id INT NOT NULL, user_id_id INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_validate TINYINT(1) NOT NULL, billing DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_E00CEDDE35F83FFC (room_id_id), INDEX IDX_E00CEDDE9D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE room (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, address VARCHAR(255) DEFAULT NULL, city VARCHAR(100) NOT NULL, zipcode VARCHAR(5) NOT NULL, capacity_min INT NOT NULL, capacity_max VARCHAR(5) NOT NULL, ergonomic LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', equipment LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', image VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', check_in_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', check_out_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
